...
class MobileNetV1(nn.Module):
    ...
    def __init__(self, dropout_keep_prob, embedding_size):
...
def get_mobilenet(dropout_keep_prob, embedding_size):
    return MobileNetV1(dropout_keep_prob, embedding_size)
